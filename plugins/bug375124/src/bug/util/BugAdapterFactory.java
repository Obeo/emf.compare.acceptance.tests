...
public class BugAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected BugSwitch<Adapter> modelSwitch =
		new BugSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bug.Class1 <em>Class1</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link bug.Class2 <em>Class2</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
