 ...
 * </copyright>
 *
 * $Id: EnclosingOperationImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getOverriddenFixedPriority <em>Overridden Fixed Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getOverriddenPermanentFP <em>Overridden Permanent FP</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getOperationList <em>Operation List</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getAverageCaseExecutionTime <em>Average Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getBestCaseExecutionTime <em>Best Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.EnclosingOperationImpl#getWorstCaseExecutionTime <em>Worst Case Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnclosingOperationImpl extends EObjectImpl implements EnclosingOperation {
	/**
