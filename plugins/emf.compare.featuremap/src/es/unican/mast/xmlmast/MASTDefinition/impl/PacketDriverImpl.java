 ...
 * </copyright>
 *
 * $Id: PacketDriverImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketDriverImpl#getMessagePartitioning <em>Message Partitioning</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketDriverImpl#getPacketReceiveOperation <em>Packet Receive Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketDriverImpl#getPacketSendOperation <em>Packet Send Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketDriverImpl#getPacketServer <em>Packet Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketDriverImpl#getRTAOverheadModel <em>RTA Overhead Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PacketDriverImpl extends EObjectImpl implements PacketDriver {
	/**
