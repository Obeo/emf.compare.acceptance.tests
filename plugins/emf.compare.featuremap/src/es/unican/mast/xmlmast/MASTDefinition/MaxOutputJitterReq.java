 ...
 * </copyright>
 *
 * $Id: MaxOutputJitterReq.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getMaxOutputJitter <em>Max Output Jitter</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getReferencedEvent <em>Referenced Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getMaxOutputJitterReq()
...
public interface MaxOutputJitterReq extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getMaxOutputJitterReq_MaxOutputJitter()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getMaxOutputJitter <em>Max Output Jitter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getMaxOutputJitter <em>Max Output Jitter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetMaxOutputJitter()
	 * @see #getMaxOutputJitter()
	...
	/**
	 * Returns whether the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getMaxOutputJitter <em>Max Output Jitter</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getMaxOutputJitterReq_ReferencedEvent()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq#getReferencedEvent <em>Referenced Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
