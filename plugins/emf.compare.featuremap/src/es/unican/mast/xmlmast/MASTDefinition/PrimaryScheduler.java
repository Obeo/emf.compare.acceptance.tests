 ...
 * </copyright>
 *
 * $Id: PrimaryScheduler.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getFixedPriorityScheduler <em>Fixed Priority Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getEDFScheduler <em>EDF Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getFPPacketBasedScheduler <em>FP Packet Based Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getHost <em>Host</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler()
...
public interface PrimaryScheduler extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler_FixedPriorityScheduler()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getFixedPriorityScheduler <em>Fixed Priority Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler_EDFScheduler()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getEDFScheduler <em>EDF Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler_FPPacketBasedScheduler()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getFPPacketBasedScheduler <em>FP Packet Based Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHost(String)
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler_Host()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getHost <em>Host</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getPrimaryScheduler_Name()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
