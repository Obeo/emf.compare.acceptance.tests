 ...
 * </copyright>
 *
 * $Id: DeliveryServer.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getDeliveryPolicy <em>Delivery Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getInputEvent <em>Input Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getOutputEventsList <em>Output Events List</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDeliveryServer()
...
public interface DeliveryServer extends EObject {
	 ...
	 * The literals are from the enumeration {@link es.unican.mast.xmlmast.MASTDefinition.DeliveryPolicy}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDeliveryServer_DeliveryPolicy()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getDeliveryPolicy <em>Delivery Policy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getDeliveryPolicy <em>Delivery Policy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetDeliveryPolicy()
	 * @see #getDeliveryPolicy()
	...
	/**
	 * Returns whether the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getDeliveryPolicy <em>Delivery Policy</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDeliveryServer_InputEvent()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getInputEvent <em>Input Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDeliveryServer_OutputEventsList()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.DeliveryServer#getOutputEventsList <em>Output Events List</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
