 ...
 * </copyright>
 *
 * $Id: SporadicServerPolicyImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getBackgroundPriority <em>Background Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getInitialCapacity <em>Initial Capacity</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getMaxPendingReplenishments <em>Max Pending Replenishments</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getNormalPriority <em>Normal Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicServerPolicyImpl#getReplenishmentPeriod <em>Replenishment Period</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SporadicServerPolicyImpl extends EObjectImpl implements SporadicServerPolicy {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SPORADIC_SERVER_POLICY__INITIAL_CAPACITY:
				return new Float(getInitialCapacity());
			...
			case ModelPackage.SPORADIC_SERVER_POLICY__REPLENISHMENT_PERIOD:
				return new Float(getReplenishmentPeriod());
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.SPORADIC_SERVER_POLICY__BACKGROUND_PRIORITY:
				...
				return;
			case ModelPackage.SPORADIC_SERVER_POLICY__INITIAL_CAPACITY:
				setInitialCapacity(((Float)newValue).floatValue());
				return;
			case ModelPackage.SPORADIC_SERVER_POLICY__MAX_PENDING_REPLENISHMENTS:
			...
			case ModelPackage.SPORADIC_SERVER_POLICY__PREASSIGNED:
				...
				return;
			case ModelPackage.SPORADIC_SERVER_POLICY__REPLENISHMENT_PERIOD:
				setReplenishmentPeriod(((Float)newValue).floatValue());
				return;
		}
