 ...
 * </copyright>
 *
 * $Id: RTEPPacketDriverImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getFailureTimeout <em>Failure Timeout</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getMessagePartitioning <em>Message Partitioning</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getNumberOfStations <em>Number Of Stations</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketDiscardOperation <em>Packet Discard Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketInterruptServer <em>Packet Interrupt Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketISROperation <em>Packet ISR Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketReceiveOperation <em>Packet Receive Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketRetransmissionOperation <em>Packet Retransmission Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketSendOperation <em>Packet Send Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketServer <em>Packet Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getPacketTransmissionRetries <em>Packet Transmission Retries</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getRTAOverheadModel <em>RTA Overhead Model</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getTokenCheckOperation <em>Token Check Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getTokenDelay <em>Token Delay</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getTokenManageOperation <em>Token Manage Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getTokenRetransmissionOperation <em>Token Retransmission Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RTEPPacketDriverImpl#getTokenTransmissionRetries <em>Token Transmission Retries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RTEPPacketDriverImpl extends EObjectImpl implements RTEPPacketDriver {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.RTEP_PACKET_DRIVER__FAILURE_TIMEOUT:
				return new Float(getFailureTimeout());
			...
			case ModelPackage.RTEP_PACKET_DRIVER__TOKEN_DELAY:
				return new Float(getTokenDelay());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.RTEP_PACKET_DRIVER__FAILURE_TIMEOUT:
				setFailureTimeout(((Float)newValue).floatValue());
				return;
			case ModelPackage.RTEP_PACKET_DRIVER__MESSAGE_PARTITIONING:
			...
			case ModelPackage.RTEP_PACKET_DRIVER__TOKEN_CHECK_OPERATION:
				...
				return;
			case ModelPackage.RTEP_PACKET_DRIVER__TOKEN_DELAY:
				setTokenDelay(((Float)newValue).floatValue());
				return;
			case ModelPackage.RTEP_PACKET_DRIVER__TOKEN_MANAGE_OPERATION:
