 ...
 * </copyright>
 *
 * $Id: RegularTransactionImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getPeriodicExternalEvent <em>Periodic External Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getSporadicExternalEvent <em>Sporadic External Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getUnboundedExternalEvent <em>Unbounded External Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getBurstyExternalEvent <em>Bursty External Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getSingularExternalEvent <em>Singular External Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getRegularEvent <em>Regular Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getSystemTimedActivity <em>System Timed Activity</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getConcentrator <em>Concentrator</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getBarrier <em>Barrier</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getDeliveryServer <em>Delivery Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getQueryServer <em>Query Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getMulticast <em>Multicast</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getRateDivisor <em>Rate Divisor</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularTransactionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RegularTransactionImpl extends EObjectImpl implements RegularTransaction {
	/**
