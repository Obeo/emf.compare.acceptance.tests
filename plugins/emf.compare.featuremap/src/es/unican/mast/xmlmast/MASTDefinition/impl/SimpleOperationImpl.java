 ...
 * </copyright>
 *
 * $Id: SimpleOperationImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getOverriddenFixedPriority <em>Overridden Fixed Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getOverriddenPermanentFP <em>Overridden Permanent FP</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getSharedResourcesList <em>Shared Resources List</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getSharedResourcesToLock <em>Shared Resources To Lock</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getSharedResourcesToUnlock <em>Shared Resources To Unlock</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getAverageCaseExecutionTime <em>Average Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getBestCaseExecutionTime <em>Best Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SimpleOperationImpl#getWorstCaseExecutionTime <em>Worst Case Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SimpleOperationImpl extends EObjectImpl implements SimpleOperation {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.SIMPLE_OPERATION__SHARED_RESOURCES_TO_UNLOCK:
				...
				return;
			case ModelPackage.SIMPLE_OPERATION__AVERAGE_CASE_EXECUTION_TIME:
				setAverageCaseExecutionTime(((Float)newValue).floatValue());
				return;
			case ModelPackage.SIMPLE_OPERATION__BEST_CASE_EXECUTION_TIME:
				setBestCaseExecutionTime(((Float)newValue).floatValue());
				return;
			case ModelPackage.SIMPLE_OPERATION__NAME:
				setName((String)newValue);
				return;
			case ModelPackage.SIMPLE_OPERATION__WORST_CASE_EXECUTION_TIME:
				setWorstCaseExecutionTime(((Float)newValue).floatValue());
				return;
		}
