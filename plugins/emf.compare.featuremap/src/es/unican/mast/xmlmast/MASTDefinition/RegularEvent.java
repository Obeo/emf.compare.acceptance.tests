 ...
 * </copyright>
 *
 * $Id: RegularEvent.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getGroup <em>Group</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getMaxOutputJitterReq <em>Max Output Jitter Req</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getHardGlobalDeadline <em>Hard Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getSoftGlobalDeadline <em>Soft Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getGlobalMaxMissRatio <em>Global Max Miss Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getHardLocalDeadline <em>Hard Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getSoftLocalDeadline <em>Soft Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getLocalMaxMissRatio <em>Local Max Miss Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getCompositeTimingRequirement <em>Composite Timing Requirement</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent()
...
public interface RegularEvent extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_Group()
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_MaxOutputJitterReq()
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_HardGlobalDeadline()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_SoftGlobalDeadline()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_GlobalMaxMissRatio()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_HardLocalDeadline()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_SoftLocalDeadline()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_LocalMaxMissRatio()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link es.unican.mast.xmlmast.MASTDefinition.CompositeTimingRequirement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_CompositeTimingRequirement()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setEvent(String)
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRegularEvent_Event()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.RegularEvent#getEvent <em>Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
