 ...
 * </copyright>
 *
 * $Id: RateDivisor.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getInputEvent <em>Input Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getOutputEvent <em>Output Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getRateFactor <em>Rate Factor</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRateDivisor()
...
public interface RateDivisor extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRateDivisor_InputEvent()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getInputEvent <em>Input Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRateDivisor_OutputEvent()
	 * @model dataType="es.unican.mast.xmlmast.MASTDefinition.IdentifierRef" required="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getOutputEvent <em>Output Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getRateDivisor_RateFactor()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.RateDivisor#getRateFactor <em>Rate Factor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
