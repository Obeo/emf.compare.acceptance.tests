 ...
 * </copyright>
 *
 * $Id: Delay.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMaxInterval <em>Delay Max Interval</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMinInterval <em>Delay Min Interval</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getInputEvent <em>Input Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getOutputEvent <em>Output Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDelay()
...
public interface Delay extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDelay_DelayMaxInterval()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMaxInterval <em>Delay Max Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMaxInterval <em>Delay Max Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetDelayMaxInterval()
	 * @see #getDelayMaxInterval()
	...
	/**
	 * Returns whether the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMaxInterval <em>Delay Max Interval</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDelay_DelayMinInterval()
	 * @model unsettable="true" dataType="es.unican.mast.xmlmast.MASTDefinition.Time"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMinInterval <em>Delay Min Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMinInterval <em>Delay Min Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetDelayMinInterval()
	 * @see #getDelayMinInterval()
	...
	/**
	 * Returns whether the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getDelayMinInterval <em>Delay Min Interval</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDelay_InputEvent()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getInputEvent <em>Input Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getDelay_OutputEvent()
	 * @model dataType="es.unican.mast.xmlmast.MASTDefinition.IdentifierRef" required="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.Delay#getOutputEvent <em>Output Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
