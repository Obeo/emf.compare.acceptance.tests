 ...
 * </copyright>
 *
 * $Id: SecondaryScheduler.java,v 1.1 2008/09/24 14:01:08 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getFixedPriorityScheduler <em>Fixed Priority Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getEDFScheduler <em>EDF Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getFPPacketBasedScheduler <em>FP Packet Based Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getHost <em>Host</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler()
...
public interface SecondaryScheduler extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler_FixedPriorityScheduler()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getFixedPriorityScheduler <em>Fixed Priority Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler_EDFScheduler()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getEDFScheduler <em>EDF Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler_FPPacketBasedScheduler()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getFPPacketBasedScheduler <em>FP Packet Based Scheduler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHost(String)
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler_Host()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getHost <em>Host</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#getSecondaryScheduler_Name()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
