 ...
 * </copyright>
 *
 * $Id: PollingPolicyImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getPollingAvgOverhead <em>Polling Avg Overhead</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getPollingBestOverhead <em>Polling Best Overhead</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getPollingPeriod <em>Polling Period</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getPollingWorstOverhead <em>Polling Worst Overhead</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PollingPolicyImpl#getThePriority <em>The Priority</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PollingPolicyImpl extends EObjectImpl implements PollingPolicy {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.POLLING_POLICY__POLLING_AVG_OVERHEAD:
				setPollingAvgOverhead(((Float)newValue).floatValue());
				return;
			case ModelPackage.POLLING_POLICY__POLLING_BEST_OVERHEAD:
				setPollingBestOverhead(((Float)newValue).floatValue());
				return;
			case ModelPackage.POLLING_POLICY__POLLING_PERIOD:
				setPollingPeriod(((Float)newValue).floatValue());
				return;
			case ModelPackage.POLLING_POLICY__POLLING_WORST_OVERHEAD:
				setPollingWorstOverhead(((Float)newValue).floatValue());
				return;
			case ModelPackage.POLLING_POLICY__PREASSIGNED:
