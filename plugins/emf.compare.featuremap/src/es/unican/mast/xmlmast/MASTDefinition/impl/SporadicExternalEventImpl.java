 ...
 * </copyright>
 *
 * $Id: SporadicExternalEventImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicExternalEventImpl#getAvgInterarrival <em>Avg Interarrival</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicExternalEventImpl#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicExternalEventImpl#getMinInterarrival <em>Min Interarrival</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.SporadicExternalEventImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SporadicExternalEventImpl extends EObjectImpl implements SporadicExternalEvent {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SPORADIC_EXTERNAL_EVENT__MIN_INTERARRIVAL:
				return new Float(getMinInterarrival());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.SPORADIC_EXTERNAL_EVENT__DISTRIBUTION:
				...
				return;
			case ModelPackage.SPORADIC_EXTERNAL_EVENT__MIN_INTERARRIVAL:
				setMinInterarrival(((Float)newValue).floatValue());
				return;
			case ModelPackage.SPORADIC_EXTERNAL_EVENT__NAME:
