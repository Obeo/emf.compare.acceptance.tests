 ...
 * </copyright>
 *
 * $Id: RegularProcessorImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getTickerSystemTimer <em>Ticker System Timer</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getAlarmClockSystemTimer <em>Alarm Clock System Timer</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getAvgISRSwitch <em>Avg ISR Switch</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getBestISRSwitch <em>Best ISR Switch</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getMaxInterruptPriority <em>Max Interrupt Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getMinInterruptPriority <em>Min Interrupt Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getSpeedFactor <em>Speed Factor</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularProcessorImpl#getWorstISRSwitch <em>Worst ISR Switch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RegularProcessorImpl extends EObjectImpl implements RegularProcessor {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.REGULAR_PROCESSOR__AVG_ISR_SWITCH:
				return new Float(getAvgISRSwitch());
			case ModelPackage.REGULAR_PROCESSOR__BEST_ISR_SWITCH:
				return new Float(getBestISRSwitch());
			...
			case ModelPackage.REGULAR_PROCESSOR__SPEED_FACTOR:
				return new Float(getSpeedFactor());
			case ModelPackage.REGULAR_PROCESSOR__WORST_ISR_SWITCH:
				return new Float(getWorstISRSwitch());
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.REGULAR_PROCESSOR__ALARM_CLOCK_SYSTEM_TIMER:
				...
				return;
			case ModelPackage.REGULAR_PROCESSOR__AVG_ISR_SWITCH:
				setAvgISRSwitch(((Float)newValue).floatValue());
				return;
			case ModelPackage.REGULAR_PROCESSOR__BEST_ISR_SWITCH:
				setBestISRSwitch(((Float)newValue).floatValue());
				return;
			case ModelPackage.REGULAR_PROCESSOR__MAX_INTERRUPT_PRIORITY:
			...
			case ModelPackage.REGULAR_PROCESSOR__NAME:
				...
				return;
			case ModelPackage.REGULAR_PROCESSOR__SPEED_FACTOR:
				setSpeedFactor(((Float)newValue).floatValue());
				return;
			case ModelPackage.REGULAR_PROCESSOR__WORST_ISR_SWITCH:
				setWorstISRSwitch(((Float)newValue).floatValue());
				return;
		}
