 ...
 * </copyright>
 *
 * $Id: FixedPrioritySchedulerImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FixedPrioritySchedulerImpl#getAvgContextSwitch <em>Avg Context Switch</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FixedPrioritySchedulerImpl#getBestContextSwitch <em>Best Context Switch</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FixedPrioritySchedulerImpl#getMaxPriority <em>Max Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FixedPrioritySchedulerImpl#getMinPriority <em>Min Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FixedPrioritySchedulerImpl#getWorstContextSwitch <em>Worst Context Switch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FixedPrioritySchedulerImpl extends EObjectImpl implements FixedPriorityScheduler {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__AVG_CONTEXT_SWITCH:
				return new Float(getAvgContextSwitch());
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__BEST_CONTEXT_SWITCH:
				return new Float(getBestContextSwitch());
			...
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__WORST_CONTEXT_SWITCH:
				return new Float(getWorstContextSwitch());
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__AVG_CONTEXT_SWITCH:
				setAvgContextSwitch(((Float)newValue).floatValue());
				return;
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__BEST_CONTEXT_SWITCH:
				setBestContextSwitch(((Float)newValue).floatValue());
				return;
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__MAX_PRIORITY:
			...
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__MIN_PRIORITY:
				...
				return;
			case ModelPackage.FIXED_PRIORITY_SCHEDULER__WORST_CONTEXT_SWITCH:
				setWorstContextSwitch(((Float)newValue).floatValue());
				return;
		}
