 ...
 * </copyright>
 *
 * $Id: CharacterPacketDriverImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getCharacterReceiveOperation <em>Character Receive Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getCharacterSendOperation <em>Character Send Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getCharacterServer <em>Character Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getCharacterTransmissionTime <em>Character Transmission Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getMessagePartitioning <em>Message Partitioning</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getPacketReceiveOperation <em>Packet Receive Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getPacketSendOperation <em>Packet Send Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getPacketServer <em>Packet Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CharacterPacketDriverImpl#getRTAOverheadModel <em>RTA Overhead Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CharacterPacketDriverImpl extends EObjectImpl implements CharacterPacketDriver {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.CHARACTER_PACKET_DRIVER__CHARACTER_TRANSMISSION_TIME:
				return new Float(getCharacterTransmissionTime());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.CHARACTER_PACKET_DRIVER__CHARACTER_SERVER:
				...
				return;
			case ModelPackage.CHARACTER_PACKET_DRIVER__CHARACTER_TRANSMISSION_TIME:
				setCharacterTransmissionTime(((Float)newValue).floatValue());
				return;
			case ModelPackage.CHARACTER_PACKET_DRIVER__MESSAGE_PARTITIONING:
