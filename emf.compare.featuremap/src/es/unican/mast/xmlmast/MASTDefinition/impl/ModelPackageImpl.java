 ...
 * </copyright>
 *
 * $Id: ModelPackageImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
package es.unican.mast.xmlmast.MASTDefinition.impl;

import es.unican.mast.xmlmast.MASTDefinition.Activity;
import es.unican.mast.xmlmast.MASTDefinition.AffirmativeAssertion;
import es.unican.mast.xmlmast.MASTDefinition.AlarmClockSystemTimer;
import es.unican.mast.xmlmast.MASTDefinition.Assertion;
import es.unican.mast.xmlmast.MASTDefinition.Barrier;
import es.unican.mast.xmlmast.MASTDefinition.BurstyExternalEvent;
import es.unican.mast.xmlmast.MASTDefinition.CharacterPacketDriver;
import es.unican.mast.xmlmast.MASTDefinition.CompositeOperation;
import es.unican.mast.xmlmast.MASTDefinition.CompositeTimingRequirement;
import es.unican.mast.xmlmast.MASTDefinition.Concentrator;
import es.unican.mast.xmlmast.MASTDefinition.Delay;
import es.unican.mast.xmlmast.MASTDefinition.DeliveryPolicy;
import es.unican.mast.xmlmast.MASTDefinition.DeliveryServer;
import es.unican.mast.xmlmast.MASTDefinition.DistributionType;
import es.unican.mast.xmlmast.MASTDefinition.DocumentRoot;
import es.unican.mast.xmlmast.MASTDefinition.EDFPolicy;
import es.unican.mast.xmlmast.MASTDefinition.EDFScheduler;
import es.unican.mast.xmlmast.MASTDefinition.EnclosingOperation;
import es.unican.mast.xmlmast.MASTDefinition.FPPacketBasedScheduler;
import es.unican.mast.xmlmast.MASTDefinition.FixedPriorityPolicy;
import es.unican.mast.xmlmast.MASTDefinition.FixedPriorityScheduler;
import es.unican.mast.xmlmast.MASTDefinition.GlobalMaxMissRatio;
import es.unican.mast.xmlmast.MASTDefinition.HardGlobalDeadline;
import es.unican.mast.xmlmast.MASTDefinition.HardLocalDeadline;
import es.unican.mast.xmlmast.MASTDefinition.ImmediateCeilingResource;
import es.unican.mast.xmlmast.MASTDefinition.InterruptFPPolicy;
import es.unican.mast.xmlmast.MASTDefinition.ListOfDrivers;
import es.unican.mast.xmlmast.MASTDefinition.LocalMaxMissRatio;
import es.unican.mast.xmlmast.MASTDefinition.MASTMODELType;
import es.unican.mast.xmlmast.MASTDefinition.MaxOutputJitterReq;
import es.unican.mast.xmlmast.MASTDefinition.MessageTransmission;
import es.unican.mast.xmlmast.MASTDefinition.ModelFactory;
import es.unican.mast.xmlmast.MASTDefinition.ModelPackage;
import es.unican.mast.xmlmast.MASTDefinition.Multicast;
import es.unican.mast.xmlmast.MASTDefinition.NegativeAssertion;
import es.unican.mast.xmlmast.MASTDefinition.NonPreemptibleFPPolicy;
import es.unican.mast.xmlmast.MASTDefinition.Offset;
import es.unican.mast.xmlmast.MASTDefinition.OverheadType;
import es.unican.mast.xmlmast.MASTDefinition.OverriddenFixedPriority;
import es.unican.mast.xmlmast.MASTDefinition.OverriddenPermanentFP;
import es.unican.mast.xmlmast.MASTDefinition.PacketBasedNetwork;
import es.unican.mast.xmlmast.MASTDefinition.PacketDriver;
import es.unican.mast.xmlmast.MASTDefinition.PeriodicExternalEvent;
import es.unican.mast.xmlmast.MASTDefinition.PollingPolicy;
import es.unican.mast.xmlmast.MASTDefinition.PrimaryScheduler;
import es.unican.mast.xmlmast.MASTDefinition.PriorityInheritanceProtocol;
import es.unican.mast.xmlmast.MASTDefinition.PriorityInheritanceResource;
import es.unican.mast.xmlmast.MASTDefinition.QueryServer;
import es.unican.mast.xmlmast.MASTDefinition.RTEPPacketDriver;
import es.unican.mast.xmlmast.MASTDefinition.RateDivisor;
import es.unican.mast.xmlmast.MASTDefinition.RegularEvent;
import es.unican.mast.xmlmast.MASTDefinition.RegularProcessor;
import es.unican.mast.xmlmast.MASTDefinition.RegularSchedulingServer;
import es.unican.mast.xmlmast.MASTDefinition.RegularTransaction;
import es.unican.mast.xmlmast.MASTDefinition.RequestPolicy;
import es.unican.mast.xmlmast.MASTDefinition.SRPParameters;
import es.unican.mast.xmlmast.MASTDefinition.SRPResource;
import es.unican.mast.xmlmast.MASTDefinition.SecondaryScheduler;
import es.unican.mast.xmlmast.MASTDefinition.SimpleOperation;
import es.unican.mast.xmlmast.MASTDefinition.SingularExternalEvent;
import es.unican.mast.xmlmast.MASTDefinition.SoftGlobalDeadline;
import es.unican.mast.xmlmast.MASTDefinition.SoftLocalDeadline;
import es.unican.mast.xmlmast.MASTDefinition.SporadicExternalEvent;
import es.unican.mast.xmlmast.MASTDefinition.SporadicServerPolicy;
import es.unican.mast.xmlmast.MASTDefinition.SystemTimedActivity;
import es.unican.mast.xmlmast.MASTDefinition.TickerSystemTimer;
import es.unican.mast.xmlmast.MASTDefinition.TransmissionType;
import es.unican.mast.xmlmast.MASTDefinition.UnboundedExternalEvent;

import es.unican.mast.xmlmast.MASTDefinition.util.ModelValidator;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @generated
	 */
	private EDataType floatingPointEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType floatingPointObjectEDataType = null;
	 ...
	 * @see es.unican.mast.xmlmast.MASTDefinition.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EDataType getFloatingPoint() {
		return floatingPointEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getFloatingPointObject() {
		return floatingPointObjectEDataType;
	}
	...
	public void createPackageContents() {
		...
		floatingPointEDataType = createEDataType(FLOATING_POINT);
		floatingPointObjectEDataType = createEDataType(FLOATING_POINT_OBJECT);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPacketBasedNetwork_SpeedFactor(), this.getFloatingPoint(), "speedFactor", null, 0, 1, PacketBasedNetwork.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRegularProcessor_SpeedFactor(), this.getFloatingPoint(), "speedFactor", null, 0, 1, RegularProcessor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEDataType(floatingPointEDataType, float.class, "FloatingPoint", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(floatingPointObjectEDataType, Float.class, "FloatingPointObject", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (floatingPointObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "FloatingPoint:Object",
			 "baseType", "FloatingPoint"
		   });		
		addAnnotation
