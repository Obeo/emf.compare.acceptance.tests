 ...
 * </copyright>
 *
 * $Id: RegularSchedulingServerImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getNonPreemptibleFPPolicy <em>Non Preemptible FP Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getFixedPriorityPolicy <em>Fixed Priority Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getInterruptFPPolicy <em>Interrupt FP Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getPollingPolicy <em>Polling Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getSporadicServerPolicy <em>Sporadic Server Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getEDFPolicy <em>EDF Policy</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getSRPParameters <em>SRP Parameters</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularSchedulingServerImpl#getScheduler <em>Scheduler</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RegularSchedulingServerImpl extends EObjectImpl implements RegularSchedulingServer {
	/**
