 ...
 * </copyright>
 *
 * $Id: MessageTransmissionImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getOverriddenFixedPriority <em>Overridden Fixed Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getOverriddenPermanentFP <em>Overridden Permanent FP</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getAvgMessageSize <em>Avg Message Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getMaxMessageSize <em>Max Message Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getMinMessageSize <em>Min Message Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MessageTransmissionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MessageTransmissionImpl extends EObjectImpl implements MessageTransmission {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.MESSAGE_TRANSMISSION__OVERRIDDEN_PERMANENT_FP:
				...
				return;
			case ModelPackage.MESSAGE_TRANSMISSION__AVG_MESSAGE_SIZE:
				setAvgMessageSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.MESSAGE_TRANSMISSION__MAX_MESSAGE_SIZE:
				setMaxMessageSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.MESSAGE_TRANSMISSION__MIN_MESSAGE_SIZE:
				setMinMessageSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.MESSAGE_TRANSMISSION__NAME:
