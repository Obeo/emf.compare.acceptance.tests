 ...
 * </copyright>
 *
 * $Id: CompositeTimingRequirementImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getMaxOutputJitterReq <em>Max Output Jitter Req</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getHardGlobalDeadline <em>Hard Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getSoftGlobalDeadline <em>Soft Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getGlobalMaxMissRatio <em>Global Max Miss Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getHardLocalDeadline <em>Hard Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getSoftLocalDeadline <em>Soft Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.CompositeTimingRequirementImpl#getLocalMaxMissRatio <em>Local Max Miss Ratio</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CompositeTimingRequirementImpl extends EObjectImpl implements CompositeTimingRequirement {
	/**
