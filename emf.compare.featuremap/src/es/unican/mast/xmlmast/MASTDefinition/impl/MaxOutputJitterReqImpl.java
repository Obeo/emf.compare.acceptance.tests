 ...
 * </copyright>
 *
 * $Id: MaxOutputJitterReqImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MaxOutputJitterReqImpl#getMaxOutputJitter <em>Max Output Jitter</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MaxOutputJitterReqImpl#getReferencedEvent <em>Referenced Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MaxOutputJitterReqImpl extends EObjectImpl implements MaxOutputJitterReq {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.MAX_OUTPUT_JITTER_REQ__MAX_OUTPUT_JITTER:
				return new Float(getMaxOutputJitter());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.MAX_OUTPUT_JITTER_REQ__MAX_OUTPUT_JITTER:
				setMaxOutputJitter(((Float)newValue).floatValue());
				return;
			case ModelPackage.MAX_OUTPUT_JITTER_REQ__REFERENCED_EVENT:
