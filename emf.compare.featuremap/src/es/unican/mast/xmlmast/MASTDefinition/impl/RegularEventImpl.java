 ...
 * </copyright>
 *
 * $Id: RegularEventImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getMaxOutputJitterReq <em>Max Output Jitter Req</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getHardGlobalDeadline <em>Hard Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getSoftGlobalDeadline <em>Soft Global Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getGlobalMaxMissRatio <em>Global Max Miss Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getHardLocalDeadline <em>Hard Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getSoftLocalDeadline <em>Soft Local Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getLocalMaxMissRatio <em>Local Max Miss Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getCompositeTimingRequirement <em>Composite Timing Requirement</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.RegularEventImpl#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RegularEventImpl extends EObjectImpl implements RegularEvent {
	/**
