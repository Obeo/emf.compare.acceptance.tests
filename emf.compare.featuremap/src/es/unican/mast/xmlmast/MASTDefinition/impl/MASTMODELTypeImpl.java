 ...
 * </copyright>
 *
 * $Id: MASTMODELTypeImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getRegularProcessor <em>Regular Processor</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getPacketBasedNetwork <em>Packet Based Network</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getRegularSchedulingServer <em>Regular Scheduling Server</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getImmediateCeilingResource <em>Immediate Ceiling Resource</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getPriorityInheritanceResource <em>Priority Inheritance Resource</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getSRPResource <em>SRP Resource</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getSimpleOperation <em>Simple Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getMessageTransmission <em>Message Transmission</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getCompositeOperation <em>Composite Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getEnclosingOperation <em>Enclosing Operation</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getRegularTransaction <em>Regular Transaction</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getPrimaryScheduler <em>Primary Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getSecondaryScheduler <em>Secondary Scheduler</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getModelDate <em>Model Date</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getModelName <em>Model Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.MASTMODELTypeImpl#getSystemPiPBehaviour <em>System Pi PBehaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MASTMODELTypeImpl extends EObjectImpl implements MASTMODELType {
	/**
