 ...
 * </copyright>
 *
 * $Id: FPPacketBasedSchedulerImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FPPacketBasedSchedulerImpl#getMaxPriority <em>Max Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FPPacketBasedSchedulerImpl#getMinPriority <em>Min Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FPPacketBasedSchedulerImpl#getPacketOverheadAvgSize <em>Packet Overhead Avg Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FPPacketBasedSchedulerImpl#getPacketOverheadMaxSize <em>Packet Overhead Max Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.FPPacketBasedSchedulerImpl#getPacketOverheadMinSize <em>Packet Overhead Min Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FPPacketBasedSchedulerImpl extends EObjectImpl implements FPPacketBasedScheduler {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.FP_PACKET_BASED_SCHEDULER__MIN_PRIORITY:
				...
				return;
			case ModelPackage.FP_PACKET_BASED_SCHEDULER__PACKET_OVERHEAD_AVG_SIZE:
				setPacketOverheadAvgSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.FP_PACKET_BASED_SCHEDULER__PACKET_OVERHEAD_MAX_SIZE:
				setPacketOverheadMaxSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.FP_PACKET_BASED_SCHEDULER__PACKET_OVERHEAD_MIN_SIZE:
				setPacketOverheadMinSize(((Float)newValue).floatValue());
				return;
		}
