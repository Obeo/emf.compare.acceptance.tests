 ...
 * </copyright>
 *
 * $Id: PacketBasedNetworkImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getListOfDrivers <em>List Of Drivers</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getMaxBlocking <em>Max Blocking</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getMaxPacketSize <em>Max Packet Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getMinPacketSize <em>Min Packet Size</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getSpeedFactor <em>Speed Factor</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PacketBasedNetworkImpl#getTransmission <em>Transmission</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PacketBasedNetworkImpl extends EObjectImpl implements PacketBasedNetwork {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PACKET_BASED_NETWORK__THROUGHPUT:
				return new Float(getThroughput());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.PACKET_BASED_NETWORK__LIST_OF_DRIVERS:
				...
				return;
			case ModelPackage.PACKET_BASED_NETWORK__MAX_BLOCKING:
				setMaxBlocking(((Float)newValue).floatValue());
				return;
			case ModelPackage.PACKET_BASED_NETWORK__MAX_PACKET_SIZE:
				setMaxPacketSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.PACKET_BASED_NETWORK__MIN_PACKET_SIZE:
				setMinPacketSize(((Float)newValue).floatValue());
				return;
			case ModelPackage.PACKET_BASED_NETWORK__NAME:
			...
			case ModelPackage.PACKET_BASED_NETWORK__SPEED_FACTOR:
				...
				return;
			case ModelPackage.PACKET_BASED_NETWORK__THROUGHPUT:
				setThroughput(((Float)newValue).floatValue());
				return;
			case ModelPackage.PACKET_BASED_NETWORK__TRANSMISSION:
