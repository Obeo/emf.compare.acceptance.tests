 ...
 * </copyright>
 *
 * $Id: OffsetImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.OffsetImpl#getDelayMaxInterval <em>Delay Max Interval</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.OffsetImpl#getDelayMinInterval <em>Delay Min Interval</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.OffsetImpl#getInputEvent <em>Input Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.OffsetImpl#getOutputEvent <em>Output Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.OffsetImpl#getReferencedEvent <em>Referenced Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OffsetImpl extends EObjectImpl implements Offset {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.OFFSET__DELAY_MAX_INTERVAL:
				return new Float(getDelayMaxInterval());
			case ModelPackage.OFFSET__DELAY_MIN_INTERVAL:
				return new Float(getDelayMinInterval());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.OFFSET__DELAY_MAX_INTERVAL:
				setDelayMaxInterval(((Float)newValue).floatValue());
				return;
			case ModelPackage.OFFSET__DELAY_MIN_INTERVAL:
				setDelayMinInterval(((Float)newValue).floatValue());
				return;
			case ModelPackage.OFFSET__INPUT_EVENT:
