 ...
 * </copyright>
 *
 * $Id: BurstyExternalEventImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.BurstyExternalEventImpl#getAvgInterarrival <em>Avg Interarrival</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.BurstyExternalEventImpl#getBoundInterval <em>Bound Interval</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.BurstyExternalEventImpl#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.BurstyExternalEventImpl#getMaxArrivals <em>Max Arrivals</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.BurstyExternalEventImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BurstyExternalEventImpl extends EObjectImpl implements BurstyExternalEvent {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.BURSTY_EXTERNAL_EVENT__AVG_INTERARRIVAL:
				return new Float(getAvgInterarrival());
			case ModelPackage.BURSTY_EXTERNAL_EVENT__BOUND_INTERVAL:
				return new Float(getBoundInterval());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.BURSTY_EXTERNAL_EVENT__AVG_INTERARRIVAL:
				setAvgInterarrival(((Float)newValue).floatValue());
				return;
			case ModelPackage.BURSTY_EXTERNAL_EVENT__BOUND_INTERVAL:
				setBoundInterval(((Float)newValue).floatValue());
				return;
			case ModelPackage.BURSTY_EXTERNAL_EVENT__DISTRIBUTION:
