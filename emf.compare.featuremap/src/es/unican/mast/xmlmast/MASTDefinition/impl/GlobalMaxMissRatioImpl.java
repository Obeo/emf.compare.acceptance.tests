 ...
 * </copyright>
 *
 * $Id: GlobalMaxMissRatioImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.GlobalMaxMissRatioImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.GlobalMaxMissRatioImpl#getRatio <em>Ratio</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.GlobalMaxMissRatioImpl#getReferencedEvent <em>Referenced Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalMaxMissRatioImpl extends EObjectImpl implements GlobalMaxMissRatio {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.GLOBAL_MAX_MISS_RATIO__DEADLINE:
				...
				return;
			case ModelPackage.GLOBAL_MAX_MISS_RATIO__RATIO:
				setRatio(((Float)newValue).floatValue());
				return;
			case ModelPackage.GLOBAL_MAX_MISS_RATIO__REFERENCED_EVENT:
