 ...
 * </copyright>
 *
 * $Id: PeriodicExternalEventImpl.java,v 1.1 2008/09/24 14:01:09 any Exp $
 */
 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PeriodicExternalEventImpl#getMaxJitter <em>Max Jitter</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PeriodicExternalEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PeriodicExternalEventImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.MASTDefinition.impl.PeriodicExternalEventImpl#getPhase <em>Phase</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PeriodicExternalEventImpl extends EObjectImpl implements PeriodicExternalEvent {
	/**
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.PERIODIC_EXTERNAL_EVENT__MAX_JITTER:
				setMaxJitter(((Float)newValue).floatValue());
				return;
			case ModelPackage.PERIODIC_EXTERNAL_EVENT__NAME:
				setName((String)newValue);
				return;
			case ModelPackage.PERIODIC_EXTERNAL_EVENT__PERIOD:
				setPeriod(((Float)newValue).floatValue());
				return;
			case ModelPackage.PERIODIC_EXTERNAL_EVENT__PHASE:
				setPhase(((Float)newValue).floatValue());
				return;
		}
